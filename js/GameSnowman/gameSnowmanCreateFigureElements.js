function createSnowmanFigure() {
    ...
    let elementId1 = "containerGameSnowmanAnimation";
    ...
    element2.setAttribute('id', IdChild);
    document.getElementById(elementId1).append(element2);
    ...
    // let parentDiv = document.createElement('div');
    // parentDiv.setAttribute('id', IdChild);
    // document.getElementById(elementId1).append(parentDiv);
